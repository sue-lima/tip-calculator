<template>
  <div>
    ...
    <div>
      ...
      <BaseInput type="number" :min="0" step="0.01" v-model="store.billValue" @update:modelValue="store.billValue = $event" />
    </div>
    ...
    <div>
      ...
      <div>
        <label>10</label>
        <BaseSlider :min="10" :max="20" v-model="store.tipPercent" @update:modelValue="store.tipPercent = $event" />
        <label>20</label>
      </div>
    </div>
    ...
    <div>
      ...
      <div>
        <label>2</label>
        <BaseSlider :min="2" :max="16" v-model="store.peopleCount" @update:modelValue="store.peopleCount = $event" />
        <label>16</label>
      </div>
    </div>
  </div>
