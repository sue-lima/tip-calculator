<template>
  <div class="flex flex-col items-center gap-7">
    ...
    <div>
      ...
      <BaseInput type="number" :min="0" step="0.01" v-model="store.billValue" class="flex h-9 w-full rounded-md border border-indigo-600 bg-indigo-100 text-indigo-800 focus:ring-2 focus:ring-indigo-200" />
    </div>
