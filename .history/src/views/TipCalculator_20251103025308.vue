<template>
  ...
  <main class="flex-1 flex flex-col items-center justify-center p-6 bg-red-700">
    <h1>Le/Tip</h1>
    <TipForm class="w-full flex flex-col transition-all duration-500 md:flex-row md:gap-6" />
    <TipResult class="w-full flex flex-col transition-all duration-500 md:flex-row md:gap-6" />
  </main>
  <footer class="grow-0">
