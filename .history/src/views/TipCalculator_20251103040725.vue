<template>
  <div class="min-h-screen flex flex-col bg-indigo-200">
    ...
    <main class="flex-1 flex flex-col items-center justify-center">
      ...
      <div class="w-full flex flex-col transition-all duration-500 md:flex md:flex-row md:justify-around md:items-baseline md:h-full md:w-1/2">
        <!-- TipForm -->
        <div :class="['md:w-1/2 md:flex md:flex-col md:items-center md:gap-7', isMobile && betweenPanel ? 'hidden' : 'block']">
          <TipForm />
        </div>

        <!-- TipResult -->
        <div :class="['md:w-1/2 md:block md:flex md:flex-col md:items-center md:gap-7', isMobile && !betweenPanel ? 'hidden' : 'block']">
          <TipResult />
        </div>
      </div>
