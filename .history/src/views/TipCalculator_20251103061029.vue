<template>
  <div class="tip-calculator min-h-screen flex flex-col">
    ...
    <main class="tip-calculator__main flex-1 flex flex-col items-center justify-center">
      ...
      <!-- Mobile button -->
      <div class="tip-calculator__mobile-button block md:hidden mt-4">
        <button class="tip-calculator__mobile-toggle w-12 h-12 rounded-full cursor-pointer bg-sky-950 flex items-center justify-end" @click="handlePanel">
          <i :class="icon"></i>
        </button>
      </div>
    </main>
