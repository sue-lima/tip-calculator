<template>
  <div class="min-h-screen flex flex-col">
    <header class="flex justify-end p-5">
      <BaseToggle v-model="isDark" @toggle="handleDarkTheme"/>
    </header>
    <main class="flex-1 flex flex-col items-center justify-center">
      <h1 class="font-bold text-7xl">Le/Tip</h1>

      <!-- Container dos componentes -->
      <div class="w-full flex flex-col transition-all pt-5 duration-500 md:flex md:flex-row md:justify-around md:items-baseline md:h-full md:w-1/2">
        <!-- TipForm -->
